...
> 本项目（DBAuto）仅供个人**学习、研究与技术交流**使用，不得用于任何商业用途或违反法律法规的活动。
> 完整的《使用协议》（含第三方服务合规、数据安全、隐私与日志、责任限制、开源许可、协议修改与争议解决等条款）详见仓库根目录 **[使用协议.md](使用协议.md)**。部署或使用本项目的任何功能，即表示你已阅读、理解并同意该协议。
